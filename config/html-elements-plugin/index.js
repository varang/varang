  ...
  const attributes = Object.getOwnPropertyNames(attrMap)
    ...
    .map(function(name) {
      ...
      if (publicPath) {
        ...
        if (usePublicPath) {
          // remove a starting trailing slash if the label has one so we wont have //
 ...
 *      ],
 *      meta: [
 *        { label: "msapplication-TileColor", content: "#00bcd4" }
 *      ]
 *    }
 *
 * getHeadTags(ds);
 * // "<link rel="apple-touch-icon" sizes="57x57" href="/assets/icon/apple-icon-57x57.png">"
 *    "<meta label="msapplication-TileColor" content="#00bcd4">"
 *
 * @returns {string}
 */
